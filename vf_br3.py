...
def compare_truck_brightness_ratio(
    ...
    """
    Compare brightness structure between two prepared working masks.

    The masks are assumed to be already prepared outside this function.
    """
...
# masks are assumed to be already prepared, for example:
# work_mask1 = prepare_work_mask(mask1, src_pts, top_fraction=0.45)
# work_mask2 = prepare_work_mask(mask2, dst_pts, top_fraction=0.45)

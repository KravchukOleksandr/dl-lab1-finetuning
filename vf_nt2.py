...
def neutral_weight(
    ...
    """
    Smooth neutral-content weight as a function of chroma.

    Small chroma gives weight close to one.
    Large chroma gives weight close to zero.
    """
...
ratio_12, ratio_21, ratio_min, hist1, hist2 = compare_truck_neutral_ratio(
    image1=img1,
    mask1=mask1,
    src_pts=src_pts,
    image2=img2,
...
print("neutral ratio 1->2:", ratio_12)
print("neutral ratio 2->1:", ratio_21)
print("neutral ratio final:", ratio_min)
print("neutral hist1:", hist1)
print("neutral hist2:", hist2)